...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/doctrine/mongodb-odm-bundle/DataCollector/CommandDataCollector.php';
            ...
            include_once $this->targetDirs[3].'/vendor/doctrine/mongodb-odm/lib/Doctrine/ODM/MongoDB/APM/CommandLoggerInterface.php';
            include_once $this->targetDirs[3].'/vendor/doctrine/mongodb-odm/lib/Doctrine/ODM/MongoDB/APM/CommandLogger.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hEV1kkhevp', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jvk0+iyH79', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Doctrine\Bundle\MongoDBBundle\DataCollector\CommandDataCollector(($this->privates['doctrine_mongodb.odm.data_collector.command_logger'] ?? ($this->privates['doctrine_mongodb.odm.data_collector.command_logger'] = new \Doctrine\ODM\MongoDB\APM\CommandLogger()))));
        $instance->add($f);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5RGgB6jAhC', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Rrtjwh7kwK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PxRqNAo+4B', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IeWwHH7P3j', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jctuzwUOoo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addObjectInitializers([0 => new \Symfony\Bridge\Doctrine\Validator\DoctrineInitializer(($this->services['doctrine'] ?? $this->getDoctrineService())), 1 => new \Symfony\Bridge\Doctrine\Validator\DoctrineInitializer(($this->services['doctrine_mongodb'] ?? $this->getDoctrineMongodbService()))]);
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'console.command.ids' => [
                ...
                14 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\ClearMetadataCacheDoctrineODMCommand',
                15 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\CreateSchemaDoctrineODMCommand',
                16 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\DropSchemaDoctrineODMCommand',
                17 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateHydratorsDoctrineODMCommand',
                18 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\GenerateProxiesDoctrineODMCommand',
                19 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\InfoDoctrineODMCommand',
                20 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\LoadDataFixturesDoctrineODMCommand',
                21 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\QueryDoctrineODMCommand',
                22 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\ShardDoctrineODMCommand',
                23 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\TailCursorDoctrineODMCommand',
                24 => 'console.command.public_alias.Doctrine\\Bundle\\MongoDBBundle\\Command\\UpdateSchemaDoctrineODMCommand',
            ],
        ];
    }
}
