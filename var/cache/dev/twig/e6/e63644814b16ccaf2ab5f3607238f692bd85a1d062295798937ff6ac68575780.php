...
/* form.html.twig */
class __TwigTemplate_ebf9b839e919db0819a10450964e70146f5a476de8e96d71d2ba7de230ea133b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-primary\" type=\"submit\">Valider</button> <a class=\"btn btn-primary\" href=\"";
        // line 7
...
";
    ...
    {
        return array (  88 => 8,  84 => 7,  80 => 6,  76 => 5,  71 => 4,  61 => 3,  50 => 1,  48 => 2,  35 => 1,);
    }
...
{% block body %}
    ...
    {{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn btn-primary\" type=\"submit\">Valider</button> <a class=\"btn btn-primary\" href=\"{{ path('app_user_read') }}\">Retour</a>
    {{ form_end(form) }}
{% endblock %}", "form.html.twig", "/var/www/html/mongodb/templates/form.html.twig");
    }
}
